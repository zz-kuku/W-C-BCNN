% run_experiments
% clear all;Split = {6,1};run_experiments;
% clear all;Split = {6,2};run_experiments;
% clear all;Split = {6,3};run_experiments;
% clear all;Split = {6,4};run_experiments;
% 
% clear all;Split = {6,5};run_experiments;
% clear all;Split = {6,6};run_experiments;
...
%addpath(genpath('liblinear-weights'))
%% fully connected pooling 
  ...
  rcnnvd.opts = {...
    'type', 'rcnn', ...
    'model', 'data/models/imagenet-vgg-verydeep-16-ft.mat', ...
    'layer', 35} ;
...
%% bilinear pooling CNN
 ...
 % layers
  ...
  bcnnvdmft.opts = {...
    'type', 'bcnn', ...
    'modela', 'data/ft_models/bcnn-dog-dm.mat', ...
    'layera', [],...
    'modelb', [], ...
    'layerb', []
    } ;
  ...
  setupNameList = {'bcnnvdmft'};
  encoderList = {{bcnnvdmft}};
   datasetList = {{'dog', 1}};
    ...
    for jj = 1 : numSplits
      for ee = 1: numel(encoderList)
        ...
        model_train(...
          ...
          'useGpu', [2,1], ...
		  'imgScale', scales(ee), ...  
          'dataAugmentation', 'none') ;       %flipping for data augmentation. "none" for no augmentation
      end
    end
  end
% end
